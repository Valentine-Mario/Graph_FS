        ...
        Ok(config) => {
            ...
            if config.get(&acc_user).is_some() {
                ...
                if args.account_permission.is_some() {
                    doc[&acc_user]["permission"] = value(args.account_permission.unwrap())
                }
...
pub fn edit_user_acc_name() {}

pub fn edit_user_acc_password() {}

pub fn edit_user_acc_priviledge() {}
